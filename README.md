...
| assessment_tool_powershell_version | A string indicating the version of PowerShell to install.  This variable is only read if PowerShell is being installed via a package downloaded from [PowerShell/PowerShell](https://github.com/PowerShell/PowerShell). | `7.6.1` | No |
